# ==================================================================== #
# File name: camera_multithread.py
...
from tss.io import VideoWriter
from tss.ops import AppleRGB, padded_resize_image
from tss.road_objects import GeneralObject
from tss.road_objects import GMO
from tss.road_objects import MovingState
from tss.tracker import get_tracker
...
class CameraMultithread(object):
    """Camera Multi-thread.
