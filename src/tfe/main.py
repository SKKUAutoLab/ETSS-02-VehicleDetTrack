...
from tfe.cameras.camera import Camera
...
parser.add_argument(
	"--write_image",
	default=False,
	help="Should write processed images to folder"
)
...
def main():
	...
	logger.success(f"Camera init time: {camera_init_time} seconds.")
	logger.success(f"Actual processing time: {total_process_time - camera_init_time} seconds.")
