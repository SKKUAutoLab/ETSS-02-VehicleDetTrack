...
# python tools/train.py -f exps/example/custom/model_configs_yolox.py -d 4 -b 64 --fp16 -o -c weights/yolox_x.pth
...
class Exp(BaseExp):
	def __init__(self):
		...
		self.input_size = (1280, 736)  # (height, width)
		...
		self.data_dir = "/media/vsw/DATA_1/NGOCHDM/Dataset/GROUNDTRUTH_SCENES/suwon#23_03_01/"
		# name of annotation file for training
		self.train_ann = "train_annotations.json"
		# name of annotation file for evaluation
		self.val_ann = "val_annotations.json"
		# name of annotation file for testing
		self.test_ann = "val_annotations.json"
